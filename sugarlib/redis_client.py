...
# Redis connection 1
r1_cane = redis.StrictRedis(host=REDIS_HOST_CANE, port=REDIS_PORT_CANE, db=REDIS_DB_CANE)
r2_demo = redis.StrictRedis(host=REDIS_HOST_DEMO, port=REDIS_PORT_DEMO, db=REDIS_DB_DEMO)
